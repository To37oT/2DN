...
- Elle facilite la compréhension d'un projet et fait gagner un temps important.
- Elle rend le designer plus efficace.
- Il est plus rapide de nommer chaque élément **à sa création** que de tout renommer à la fin.

## 3 / 6 — Frames

🔎 **Qu'est-ce qu'une frame ?**

- C'est l'élément de base pour **structurer** un design.
...
- Site de référence : [gs.statcounter.com](https://gs.statcounter.com/screen-resolution-stats)
- Ce n'est **pas la résolution la plus utilisée** qu'il faut prendre comme référence, mais **la plus petite en largeur** parmi celles de votre cible.
...
► **À votre avis, pourquoi n'utilise-t-on pas toute la largeur de la frame ?**

## 6 / 6 — Contenu et partage
...
✏ **Dupliquer son document**

- Pour la prochaine partie, **dupliquer** le fichier (clic droit sur le fichier → *Duplicate*).
